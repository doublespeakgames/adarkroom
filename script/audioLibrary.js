...
var AudioLibrary = {
    ...
    LANDMARK_FRIENDLY_OUTPOST: 'audio/event-friendly-outpost.flac',
    LANDMARK_SWAMP: 'audio/event-swamp.flac',
    LANDMARK_CAVE: 'audio/event-cave.flac',
    LANDMARK_TOWN: 'audio/event-town.flac',
    LANDMARK_CITY: 'audio/event-city.flac',
    LANDMARK_HOUSE: 'audio/event-house.flac',
    LANDMARK_BATTLEFIELD: 'audio/event-battlefield.flac',
    LANDMARK_BOREHOLE: 'audio/event-borehole.flac',
    LANDMARK_CRASHED_SHIP: 'audio/event-crashed-ship.flac',
    LANDMARK_SULPHUR_MINE: 'audio/event-sulphurmine.flac',
    LANDMARK_COAL_MINE: 'audio/event-coalmine.flac',
    LANDMARK_IRON_MINE: 'audio/event-ironmine.flac',
    LANDMARK_DESTROYED_VILLAGE: 'audio/event-destroyed-village.flac',
